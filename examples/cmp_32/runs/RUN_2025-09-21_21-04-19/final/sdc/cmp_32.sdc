...
set_output_delay 2.0000 -clock [get_clocks {__VIRTUAL_CLK__}] -add_delay [get_ports {EQ}]
set_output_delay 2.0000 -clock [get_clocks {__VIRTUAL_CLK__}] -add_delay [get_ports {GT}]
set_output_delay 2.0000 -clock [get_clocks {__VIRTUAL_CLK__}] -add_delay [get_ports {LT}]
###############################################################################
# Environment
###############################################################################
set_load -pin_load 0.0334 [get_ports {EQ}]
set_load -pin_load 0.0334 [get_ports {GT}]
set_load -pin_load 0.0334 [get_ports {LT}]

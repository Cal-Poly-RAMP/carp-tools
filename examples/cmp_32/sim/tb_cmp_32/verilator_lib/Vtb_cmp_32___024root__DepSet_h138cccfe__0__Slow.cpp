...
VL_ATTR_COLD void Vtb_cmp_32___024root___eval_initial__TOP(Vtb_cmp_32___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_cmp_32___024root___eval_initial__TOP\n"); );
    ...
    __Vtemp_1[1U] = 0x705f3332U;
    __Vtemp_1[2U] = 0x625f636dU;
    __Vtemp_1[3U] = 0x74U;
    vlSymsp->_vm_contextp__->dumpfile(VL_CVT_PACK_STR_NW(4, __Vtemp_1));
    vlSymsp->_traceDumpOpen();
    vlSelfRef.tb_cmp_32__DOT__tb_A = 0U;
    vlSelfRef.tb_cmp_32__DOT__tb_B = 0U;
}
...
VL_ATTR_COLD void Vtb_cmp_32___024root___eval_triggers__stl(Vtb_cmp_32___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_cmp_32___024root___eval_triggers__stl\n"); );
    Vtb_cmp_32__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
